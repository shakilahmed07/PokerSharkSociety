...
function App() {
  const roadmap = [
    ...
    { title: "25% Minted", text1: "MUAY THAI RETREAT", text2: "Live Event", text3: "A two-week-long Muay Thai retreat for you and a guest in Khao Lak, Thailand. Get out of your comfort zone and hit the pads in the challenging Thai climate. Afterwards reward yourself with a massage and a fresh coconut on the beach. Includes airport transfers, accommodation and training." },
    { title: "50% Minted", text1: "POKER CRUISE", text2: "Live Event", text3: "A poker cruise for you and a guest. Relax on deck during the day and put your poker skills to the test at night. Is there a better way to go on holiday? Location TBD/ Minimum duration 5 nights." },
    { title: "75% Minted", text1: "YOGA RETREAT", text2: "Live Event", text3: "A two-week-long Yoga and Meditation retreat for you and a guest in Bali, Indonesia. Get away from it all. Reset your inner balance and maybe pick up some new techniques to help you ground yourself in everyday life. Includes airport transfers, accommodation and courses." },
    { title: "90% Minted", text1: "3D NFT DROP", text2: "Giveaway", text3: "Sharks evolve into fully rigged 3D characters that you can use as your avatar in metaverses, supporting games, and apps. That's right! You will actually receive two NFTs for the price of one." },
    {
      ...
      text2: "Live Event",
      text3: "Surely by now you`ve heard of the “Iceman”? Join Wim Hof for a week-long retreat in Poland. There will be breathing, hiking, and probably ice baths. Transfers, accommodation, and meals included. Yes, it will get cold.",
    },
  ];
  useEffect(() => {
    AOS.init({
